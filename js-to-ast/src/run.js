 ...
 * Last modified  : 2024-08-02 14:55:00
 */
...
// Ensure the vulnerabilities dictionary has a 'Literal' key
if (!vulnerabilities["Literal"]) {
    vulnerabilities["Literal"] = {};
}

// Add manually created vulnerabilities
const literalVulnerabilities = [
    {
        id: "1",
        patch: "4f8df2f6113fc55ac56e9db43f0ee240",
        hash: "db7383b991dfba6eacc2fef99ddcf52e7c4834bd"
    },
    {
        id: "1",
        patch: "4f8df2f6113fc55ac56e9db43f0ee240",
        hash: "b2d9ed949a390ecfe2150e5232ed09d12bff399d"
    },
    {
        id: "1",
        patch: "4f8df2f6113fc55ac56e9db43f0ee240",
        hash: "7ae1c57c069a8cefcc1129dec38ba0737bb08633"
    },
    {
        id: "2",
        patch: null,
        hash: "4f01a926f122ce680ae19ac416ceb8d64f773cce"
    },
    {
        id: "3",
        patch: "5c8cef7506ef500b0a0ad03e752d5901b91777f2",
        hash: "e8e907ce5d18209c9c4a1f032503b7f2b6269bdc"
    },
    {
        id: "4",
        patch: "882742bd8a389619b1df44176377133edad5e327",
        hash: "8ab27866a78cb90b217c8fbf55f45937cb605f65"
    }
];

literalVulnerabilities.forEach(({ id, patch, hash }) => {
    vulnerabilities["Literal"][hash] = { id, patch };
});

// Add manually created metadata
const metaData = [
    {
        id: "1",
...
// Ensure the vulnerabilities dictionary has a 'ForStatement' key
if (!vulnerabilities["ForStatement"]) {
    vulnerabilities["ForStatement"] = {};
}
...
// Add manually created patches
const patchesData = [
    {
        hash: "4f8df2f6113fc55ac56e9db43f0ee240",
        patch: {
            type: "Literal",
            value: {},
            raw: "/^(?:(<[\\w\\W]+>)[^>]*|#([\\w-]*))$/",
    ...
    {
        hash: "4cb7c87adf6cb47d361956495b491353bbc89580",
        patch: {
            type: "ForStatement",
            init: null,
            test: {
                ...
                operator: "<",
                right: { type: "Identifier", name: "length" }
            },
            update: {
                ...
                body: [{
                    ...
                    consequent: {
                        ...
                        body: [{
                            ...
                            right: { type: "Identifier", name: "options" },
                            body: {
                                type: "BlockStatement",
                                body: [{
                                    ...
                                    expression: {
                                        type: "AssignmentExpression",
                                        operator: "=",
                                        left: { type: "Identifier", name: "copy" },
                                        right: {
                                            type: "MemberExpression",
                                    ...
                                    test: {
                                        ...
                                        operator: "===",
                                        right: { type: "Identifier", name: "copy" }
                                    },
                                    consequent: {
                                        type: "BlockStatement",
                                    ...
                                    test: {
                                        ...
                                        right: {
                                            ...
                                            left: {
                                                ...
                                                callee: {
                                                    type: "MemberExpression",
                                                    object: { type: "Identifier", name: "jQuery" },
                                                    property: { type: "Identifier", name: "isPlainObject" },
                                                    computed: false,
                                                    optional: false
                                                },
                                                arguments: [{ type: "Identifier", name: "copy" }],
                                                optional: false
                                            },
                                            operator: "||",
                                            right: {
                                                type: "AssignmentExpression",
                                                operator: "=",
                                                left: { type: "Identifier", name: "copyIsArray" },
                                                right: {
                                                    type: "CallExpression",
                                                    callee: {
                                                        type: "MemberExpression",
                                        ...
                                        body: [{
                                            ...
                                            consequent: {
                                                ...
                                                body: [{
                                                    ...
                                                    expression: {
                                                        type: "AssignmentExpression",
                                                        operator: "=",
                                                        left: { type: "Identifier", name: "clone" },
                                            ...
                                            alternate: {
                                                ...
                                                test: {
                                                    ...
                                                    left: {
                                                        ...
                                                        operator: "!",
                                                        prefix: true,
                                                        argument: { type: "Identifier", name: "copyIsArray" }
                                                    },
                                                    operator: "&&",
                                                    right: {
                                                        type: "UnaryExpression",
                                                ...
                                                alternate: {
                                                    ...
                                                    body: [{
                                                        ...
                                                        expression: {
                                                            ...
                                                            operator: "=",
                                                            left: { type: "Identifier", name: "clone" },
                                                            right: { type: "Identifier", name: "src" }
                                                        }
                                                    }]
                                                }
                                            }
                                            ...
                                            expression: {
                                                ...
                                                right: {
                                                    ...
                                                    arguments: [{ type: "Identifier", name: "deep" }, { type: "Identifier", name: "clone" }, { type: "Identifier", name: "copy" }],
                                                    optional: false
                                                }
                                            }
                                        }]
    ...
    {
        hash: "5c8cef7506ef500b0a0ad03e752d5901b91777f2",
        patch: {
            type: "Literal",
            value: {},
    ...
    {
        hash: "882742bd8a389619b1df44176377133edad5e327",
        patch: {
            type: "Literal",
            value: {},
            raw: "/[0-9]{0,256}['a-z\\u00A0-\\u05FF\\u0700-\\uD7FF\\uF900-\\uFDCF\\uFDF0-\\uFFEF]{1,256}|[\\u0600-\\u06FF\\/]{1,256}(\\s*?[\\u0600-\\u06FF]{1,256}){1,2}/i",
            regex: {
                pattern: "[0-9]{0,256}['a-z\\u00A0-\\u05FF\\u0700-\\uD7FF\\uF900-\\uFDCF\\uFDF0-\\uFFEF]{1,256}|[\\u0600-\\u06FF\\/]{1,256}(\\s*?[\\u0600-\\u06FF]{1,256}){1,2}",
                flags: "i"
            }
        }
    }
...
patchesData.forEach(({ hash, patch }) => {
    patches[hash] = patch;
});
